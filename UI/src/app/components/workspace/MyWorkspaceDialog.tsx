...
export function MyWorkspaceDialog({
  open,
  onOpenChange,
  projectId,
  projectName,
  ...
  const renderDocumentsView = () => (
    <div className="flex h-[calc(100vh-220px)] min-h-0 min-w-0 gap-6">
      {showDocumentList ? (
          ...
          <>
            <div className="border-b border-[var(--color-border)] px-6 py-5">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2">
                <Select value={documentFontFamily} onValueChange={(value) => setDocumentFontFamily(value as typeof documentFontFamily)}>
                  <SelectTrigger className="w-[180px]">
                    <SelectValue placeholder="编辑器字体" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <Button type="button" variant="secondary" onClick={handleInsertDocumentTable}>
      ...
      <DialogContent className="!left-0 !top-0 !h-screen !w-screen !max-w-none !translate-x-0 !translate-y-0 rounded-none border-0 p-0">
        <DialogHeader className="border-b border-[var(--color-border)] px-6 py-4">
          <div className="flex items-start justify-between gap-6">
            <div>
              <DialogTitle>我的工作空间</DialogTitle>
              <DialogDescription>
